...
const ShopRegisterPage = (props) => {
  ...
  this.reverseGeocodeCoordinate = this.reverseGeocodeCoordinate.bind(this);
   ...
   reverseGeocodeCoordinate() {
       ...
       fetch("https://maps.googleapis.com/maps/api/geocode/json?latlng=${this.state.latitude},${this.state.longitude}&sensor=false&key=").then(response => response.json()).then(data => this.setState({
